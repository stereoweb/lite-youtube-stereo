...
describe('<lite-youtube>', () => {
    ...
    it('clicking button should load iframe', async () => {
        ...
        el.click();
        expect(el.shadowRoot.querySelector('iframe')).dom.to.equal('<iframe frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="" src="https://www.youtube.com/embed/guJLfqTFfIw?autoplay=1&amp;start=0&amp;null" title="Test Me"></iframe>');
    });
    it('switching videoid should reset iframe', async () => {
        ...
        expect(el.shadowRoot.querySelector('iframe')).to.be.null;
        el.click();
        expect(el.shadowRoot.querySelector('iframe')).dom.to.equal('<iframe frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="" src="https://www.youtube.com/embed/VZ9VSypxhEQ?autoplay=1&amp;start=0&amp;null" title="Test Me"></iframe>');
    });
    it('switching playlistid should reset iframe', async () => {
        ...
        expect(el.shadowRoot.querySelector('iframe')).to.be.null;
        el.click();
        expect(el.shadowRoot.querySelector('iframe')).dom.to.equal('<iframe frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="" src="https://www.youtube.com/embed/?listType=playlist&amp;list=PL-G5r6j4GptH5JTveoLTVqpp7w2oc27Q9&amp;autoplay=1&amp;start=0&amp;null" title="Test Me"></iframe>');
    });
    it('autoload should inject iframe and warm', async () => {
        const el = await fixture(html `<lite-youtube videoid="guJLfqTFfIw" autoLoad></lite-youtube>`);
        expect(document.head.querySelectorAll('link').length).to.be.equal(1);
    });
    it('nocookie attr should change iframe url target', async () => {
        const el = await fixture(html `<lite-youtube videoid="guJLfqTFfIw" nocookie></lite-youtube>`);
        el.click();
        expect(el.shadowRoot.querySelector('iframe')).dom.to.equal('<iframe frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="" src="https://www.youtube-nocookie.com/embed/guJLfqTFfIw?autoplay=1&amp;start=0&amp;null" title="Video"></iframe>');
    });
    it('posterQuality prop should update on set', async () => {
        const el = await fixture(html `<lite-youtube
        videoid="guJLfqTFfIw"
        posterQuality="mqdefault"
      ></lite-youtube>`);
        expect(el.posterQuality).to.be.equal('mqdefault');
        const fallback = el.shadowRoot?.querySelector('#fallbackPlaceholder');
    ...
    it('YouTube Short desktop check', async () => {
        const el = await fixture(html `<lite-youtube videoid="guJLfqTFfIw" short></lite-youtube>`);
    ...
    it('check for nonce injector', async () => {
        ...
        const el = await fixture(html `<lite-youtube videoid="guJLfqTFfIw"></lite-youtube>`);
        expect(el.shadowRoot.querySelector('style')?.getAttribute('nonce')).to.equal(window.liteYouTubeNonce);
    });
    it('check global preconnect state', async () => {
        ...
        expect(document.querySelectorAll('head > link[rel=preconnect]').length).to.equal(6);
    });
...
//# sourceMappingURL=lite-youtube.test.js.map